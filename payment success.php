<?php
session_start(); include('dbconnect.php'); 
?>
...
$sql2="INSERT INTO customer_order(p_id,p_qty,p_status,tr_id) VALUES ('$pid','1','CONFIRMED','$i')";
...
$i=rand(); while($cart_row=mysqli_fetch_array($run_query))
{
$cart_prod_id=$cart_row['p_id'];
$pid=$cart_prod_id;
$query_new3=mysqli_query($conn,"SELECT * FROM products WHERE product_id='$cart_prod_id'");
...
$sql2="INSERT INTO customer_order (p_id,p_qty,p_status,tr_id) VALUES ('$cart_prod_id','$cart_qty','CONFIRMED','$i')";
$run_query2=mysqli_query($conn,$sql2);
}
$_SESSION['tr_id']=$i;
...
<?php } ?>
<br><div style="font-size: 20px">Total Amount : ₹ <?php echo "$total_amount" ?></div>
<br>You can continue with your shopping.
<p></p>
<a href="goback.php" class='quickbook-btn'>Back to
store</a>
</div>
</div>
<div class='col-md-2'></div>
...
<img src="cart.avif" style="width:400px; height: 400px; position: relative; top: 0px; left: 470px;">
</body>
</html>